...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private EditText mEmail, mPassword, mName, mBudget, phone_number;
...
//    private String phonePattern = phone.length() > 6 && phone.length() <= 13;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_registration_sohan);
                                ...
                                mAuth.getCurrentUser().sendEmailVerification().addOnCompleteListener(new OnCompleteListener<Void>() {
                                    ...
                                    public void onComplete(@NonNull Task<Void> task) {
                                        if(task.isSuccessful()) {
                                            ...
                                            DatabaseReference currentUserDb = FirebaseDatabase.getInstance("https://crod-918ce-default-rtdb.firebaseio.com/").getReference().child("Users").child(userId);
